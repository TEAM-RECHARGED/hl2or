//========= Copyright HL2 Overcharged Redux Developers, All rights reserved. ============//
//
...
void CWeaponUSP::Operator_HandleAnimEvent(animevent_t* pEvent, CBaseCombatCharacter* pOperator)
{
	...
	case EVENT_WEAPON_PISTOL_FIRE:
	{
		...
		CSoundEnt::InsertSound(SOUND_COMBAT | SOUND_CONTEXT_GUNFIRE, pOperator->GetAbsOrigin(), SOUNDENT_VOLUME_USP, 0.2, pOperator, SOUNDENT_CHANNEL_WEAPON, pOperator->GetEnemy());
...
void CWeaponUSP::PrimaryAttack(void)
{
	...
	CSoundEnt::InsertSound(SOUND_COMBAT, GetAbsOrigin(), SOUNDENT_VOLUME_USP, 0.2, GetOwner());

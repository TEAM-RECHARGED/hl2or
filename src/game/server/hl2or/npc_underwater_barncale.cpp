//========= Copyright ReCharged and Overcharged, All rights reserved. ============//
//
// Purpose:		 The 'underwater' version of the barnacle
//
// $Workfile:     $
// $Date:         1/25/2025
...
ConVar	sk_waterbarnacle_health("sk_barnacle_health", "0");

static ConVar npc_waterbarnacle_swallow("npc_barnacle_swallow", "0", 0, "Use prototype swallow code.");

const char* CNPC_WATER_Barnacle::m_szGibNames[NUM_WATER_BARNACLE_GIBS] =
{

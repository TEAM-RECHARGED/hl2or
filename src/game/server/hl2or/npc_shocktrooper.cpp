...
ConVar	sk_shocktrooper_health("sk_shocktrooper_health", "50");
ConVar	sk_shocktrooper_dmg_claw("sk_shocktrooper_dmg_claw", "8");
ConVar	sk_shocktrooper_clawrake("sk_shocktrooper_clawrake", "25");
ConVar	sk_shocktrooper_dmg_zap("sk_shocktrooper_dmg_zap", "15");

LINK_ENTITY_TO_CLASS(npc_shocktrooper, CNPC_Shocktrooper);

BEGIN_DATADESC(CNPC_Shocktrooper)
...
// Spawn
//=========================================================
void CNPC_Shocktrooper::Spawn()
{
	Precache();

	SetModel("models/shocktrooper.mdl");
	...
	ClearEffects();
	m_iHealth = sk_shocktrooper_health.GetFloat();
...
//=========================================================
void CNPC_Shocktrooper::Precache()
{
	BaseClass::Precache();

	PrecacheModel("models/shocktrooper.mdl");
...
Disposition_t CNPC_Shocktrooper::IRelationType(CBaseEntity* pTarget)
{
	if ((pTarget->IsPlayer()))
	{
...
// Output :
//-----------------------------------------------------------------------------
Class_T	CNPC_Shocktrooper::Classify(void)
{
	return	CLASS_ALIEN_MILITARY;
}

void CNPC_Shocktrooper::CallForHelp(char* szClassname, float flDist, CBaseEntity* pEnemy, Vector& vecLocation)
{
...
// ALertSound - scream
//=========================================================
void CNPC_Shocktrooper::AlertSound(void)
{
	if (GetEnemy() != NULL)
	{
...
// IdleSound
//=========================================================
void CNPC_Shocktrooper::IdleSound(void)
{
...
// PainSound
//=========================================================
void CNPC_Shocktrooper::PainSound(const CTakeDamageInfo& info)
{
	if (random->RandomInt(0, 2) == 0)
	{
...
void CNPC_Shocktrooper::DeathSound(const CTakeDamageInfo& info)
{
	CPASAttenuationFilter filter(this);
	CSoundParameters params;
...
int CNPC_Shocktrooper::GetSoundInterests(void)
{
	return	SOUND_WORLD |
		SOUND_COMBAT |
		SOUND_DANGER |
...
void CNPC_Shocktrooper::Event_Killed(const CTakeDamageInfo& info)
{
	ClearBeams();
...
//=========================================================
float CNPC_Shocktrooper::MaxYawSpeed(void)
{
	float flYS;
...
//=========================================================
void CNPC_Shocktrooper::HandleAnimEvent(animevent_t* pEvent)
{
	...
	{
		// SOUND HERE!
		CBaseEntity* pHurt = CheckTraceHullAttack(40, Vector(-10, -10, -10), Vector(10, 10, 10), sk_shocktrooper_dmg_claw.GetFloat(), DMG_SLASH);
		CPASAttenuationFilter filter(this);
		if (pHurt)
		{
	...
	{
		CBaseEntity* pHurt = CheckTraceHullAttack(40, Vector(-10, -10, -10), Vector(10, 10, 10), sk_shocktrooper_clawrake.GetFloat(), DMG_SLASH);
...
// Output  :
//------------------------------------------------------------------------------
int CNPC_Shocktrooper::RangeAttack1Conditions(float flDot, float flDist)
{
	if (GetEnemy() == NULL)
...
void CNPC_Shocktrooper::StartTask(const Task_t* pTask)
{
	ClearBeams();
...
int CNPC_Shocktrooper::OnTakeDamage_Alive(const CTakeDamageInfo& inputInfo)
{
...
void CNPC_Shocktrooper::TraceAttack(const CTakeDamageInfo& info, const Vector& vecDir, trace_t* ptr, CDmgAccumulator* pAccumulator)
{
...
//=========================================================
//=========================================================
int CNPC_Shocktrooper::SelectSchedule(void)
{
	ClearBeams();
...
int CNPC_Shocktrooper::TranslateSchedule(int scheduleType)
{
...
//=========================================================
void CNPC_Shocktrooper::ArmBeam(int side)
{
	trace_t tr;
	float flDist = 1.0;
...
//=========================================================
void CNPC_Shocktrooper::BeamGlow()
{
	int b = m_iBeams * 32;
...
//=========================================================
void CNPC_Shocktrooper::WackBeam(int side, CBaseEntity* pEntity)
{
	Vector vecDest;
...
//=========================================================
void CNPC_Shocktrooper::ZapBeam(int side)
{
	...
	{
		CTakeDamageInfo info(this, this, sk_shocktrooper_dmg_zap.GetFloat(), DMG_SHOCK);
		CalculateMeleeDamageForce(&info, vecAim, tr.endpos);
...
//=========================================================
void CNPC_Shocktrooper::ClearBeams()
{
...
AI_BEGIN_CUSTOM_NPC(monster_alien_slave, CNPC_Shocktrooper)

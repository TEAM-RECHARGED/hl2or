...
#include "cbase.h"
#include "../shared/hl1/hl1mp_basecombatweapon_shared.h"
...
ConVar    sk_plr_dmg_crowbar("sk_plr_dmg_crowbar_hl2", "0");

#define	CROWBAR_HL1_RANGE		64.0f
#define	CROWBAR_HL1_REFIRE_MISS	0.5f
#define	CROWBAR_HL1_REFIRE_HIT	0.25f
...
//IMPLEMENT_NETWORKCLASS_ALIASED(CWeaponHL1Crowbar, DT_WeaponHL1Crowbar );
...
void CWeaponHL1Crowbar::Swing( void )
{
	...
	Vector swingEnd = swingStart + forward * CROWBAR_HL1_RANGE;
	...
	if ( m_traceHit.fraction == 1.0f )
	{
		...
		m_flNextPrimaryAttack = gpGlobals->curtime + CROWBAR_HL1_REFIRE_MISS;
	}
	else
	{
		Hit();
		...
		//Setup our next attack times
		m_flNextPrimaryAttack = gpGlobals->curtime + CROWBAR_HL1_REFIRE_HIT;
	}

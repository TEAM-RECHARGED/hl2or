...
class CNPC_Apache : public CBaseHL1Helicopter
{
	DECLARE_CLASS( CNPC_Apache, CBaseHL1Helicopter);
public:
	DECLARE_DATADESC();
...
void CNPC_Apache::Spawn( void )
{
	...
	m_fHelicopterFlags	= BITS_HELICOPTER_MISSILE_HL1_ON | BITS_HELICOPTER_GUN_HL1_ON;

...
// Spawnflags
//-----------------------------------------------------------------------------
#define	SF_NPCMAKER_HL1_START_ON	1	// start active ( if has targetname )
#define SF_NPCMAKER_HL1_NPCCLIP		8	// Children are blocked by NPCclip
#define SF_NPCMAKER_HL1_FADE		16	// Children's corpses fade
#define SF_NPCMAKER_HL1_INF_CHILD	32	// Infinite number of children
#define	SF_NPCMAKER_HL1_NO_DROP		64	// Do not adjust for the ground's position when checking for spawn


class CNPCHL1Maker : public CBaseEntity
{
public:
	DECLARE_CLASS( CNPCHL1Maker, CBaseEntity );

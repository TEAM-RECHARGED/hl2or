...
ConVar    sk_plr_dmg_rpg("sk_plr_dmg_rpg", "0");
...
{
	CLaserHL1Dot*pDot = assert_cast<CLaserHL1Dot* >(pLaserDot );
...
{
#ifndef CLIENT_DLL
	CLaserHL1Dot*pLaserDot = (CLaserHL1Dot*) CBaseEntity::Create( "laser_spot", origin, QAngle(0,0,0) );

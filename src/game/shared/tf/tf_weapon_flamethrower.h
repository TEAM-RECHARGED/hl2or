...
// Flamethrower Weapon
//=========================================================
class CTFFlameThrower : public CBaseHLCombatWeapon
{
	DECLARE_CLASS( CTFFlameThrower, CBaseHLCombatWeapon );
public:
	DECLARE_DATADESC();
